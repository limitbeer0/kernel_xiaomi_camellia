...
#include "ov02b10_aac_mipi_raw_Sensor.h"

#undef IMGSENSOR_I2C_1000K
#include "imgsensor_i2c.h"
#define IMGSENSOR_MODULE_ID_SUNNY       0x01
#define PFX "ov02b10_aac_camera_sensor"

#define LOG_INF(format, args...)    pr_debug(PFX "[%s] " format, __func__, ##args)
/*N6 code for HQ-306080 by p-wangjie103 at 2023/07/14 start*/
#define VENDOR_ID 0x10
/*N6 code for HQ-306080 by p-wangjie103 at 2023/07/14 end*/
...
static  imgsensor_info_struct imgsensor_info = {
    ...
    .sensor_id = OV02B10_AAC_MACRO_SENSOR_ID,
...
{
    kal_uint16 get_byte = 0;
    char pu_send_cmd[2] = {(char)(0x01 >> 8), (char)(0x01 & 0xFF) };
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    kal_uint8 retry = 2;
    /*N6 code for HQ-306080 by p-wangjie103 at 2023/07/14 start*/
    kal_uint16 imgsensor_vendor_id = 0;
    imgsensor_vendor_id = get_vendor_id();
    LOG_INF("ov02b10_aac_macro get_vendor_id is: 0x%x\n", imgsensor_vendor_id);
    if(imgsensor_vendor_id != VENDOR_ID) {
        LOG_INF("ov02b10_aac_macro get_vendor_id error:0x%x\n", imgsensor_vendor_id);
        ...
        do {
            ...
            *sensor_id += 1;
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
                //read_module_data();
                LOG_INF("ov02b10_aac i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
                return ERROR_NONE;
            }
            LOG_INF("ov02b10_aac Read sensor id fail,write_id:0x%x, id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
            retry--;
        } while (retry > 0);
        i++;
        retry = 2;
...
UINT32 OV02B10_AAC_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
